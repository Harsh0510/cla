const tempUnlockNotificationEmailSender = require("../../../../core/public/async_task/asset_available_email_log/tempUnlockNotificationEmailSender");
...
const mockAssetData = [
	{
		...
		expiration_date: "2021-09-02T09:37:04.359Z",
		asset_id: 19681,
	...
	},
	{
		...
		first_name: "Bhadresh",
		status: "does-not-exist",
		expiration_date: "2021-09-02T12:38:32.332Z",
		asset_id: 19876,
...
test(`Send an email when number of asset equal to 1 `, async () => {
	...
	const item = await tempUnlockNotificationEmailSender(userAssetData);
