...
let mockUserData, props, mockFunction, mockQuery, mockStatusData, mockResultFilter, filters, mockSelectedStatus, mockfiltersLength;
...
function getData() {
	filters = [];
	mockResultFilter = MockRolloverJobFilterData.result;
