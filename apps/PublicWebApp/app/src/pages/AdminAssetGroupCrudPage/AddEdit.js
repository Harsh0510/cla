		...
		return (
			<FormWrapAddEdit onSubmit={this.doSubmit}>
				...
				<FormBodyContainer>
					...
					<FormContainerFull>
						<FormContainerHalf>
							<label htmlFor="identifier">ISSN: </label>
							<FormInput type="text" name="identifier" placeholder="Identifier" defaultValue={fields.identifier} disabled={true} />
						</FormContainerHalf>
						<FormContainerHalf>
							<label htmlFor="active">Active?</label>
							<CheckboxContainer>
								{<CheckBoxField indeterminate={fields.active === null} value={!!fields.active} onChange={null} disable={true} name="active" />}
							</CheckboxContainer>
						</FormContainerHalf>
					</FormContainerFull>
